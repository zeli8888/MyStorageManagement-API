...
public class IngredientController {
    ...
    public ResponseEntity<List<Ingredient>> searchIngredients(@RequestParam String searchString) {
        return ResponseEntity.ok(ingredientService.searchIngredients(searchString));
    }
}
